...
INSERT INTO `printer_authentication`.`roles` (`id`, `name`, `accesslevel`, `subaccessOf`) VALUES (2, 'Power User', 36, 4);
INSERT INTO `printer_authentication`.`roles` (`id`, `name`, `accesslevel`, `subaccessOf`) VALUES (3, 'Technician', 504, 4);
INSERT INTO `printer_authentication`.`roles` (`id`, `name`, `accesslevel`, `subaccessOf`) VALUES (4, 'Manager', 0, NULL);
